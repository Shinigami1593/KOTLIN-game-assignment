...
import com.example.gameassignment.databinding.ActivityAdditionBinding
import kotlin.random.Random

class AdditionActivity : AppCompatActivity() {
    lateinit var GamePage: ActivityAdditionBinding
    var Score: Int = 0
    var life: Int = 3
    ...
    private fun checkAnswer(calc: String) {
        GamePage.NextButton.isEnabled = true
        if (life > 0) {
            ...
            if (checkInput == ans) {
                ...
                GamePage.NextButton.setOnClickListener {
                    nextQuestion(calc)
                }
            } else {
                life--
    ...
    private fun gameOver() {
        ...
        timer.cancel()
        GamePage.NextButton.setOnClickListener {
            val intent = Intent(this@AdditionActivity, GameOver::class.java)
